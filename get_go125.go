...
// g struct definition for Go 1.25 - exact copy from runtime source
type g struct {
	// Stack parameters.
...
// Get returns the current goroutine ID using the optimized assembly implementation for Go 1.25 on amd64/arm64.
